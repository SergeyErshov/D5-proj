...
# Копирование и запуск установочного скрипта на создаваемую ВМ
# Заккоментируй блок ниже, если установка докер  не нужна

  provisioner "file" {
    source      = "./docker.sh"
    destination = "/home/esm/docker.sh"
  ...
  provisioner "remote-exec" {
    inline = [
      "sudo chmod +x /home/esm/docker.sh",
      "sudo /bin/bash /home/esm/docker.sh",
    ]
